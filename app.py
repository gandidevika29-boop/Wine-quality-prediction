...
/* Sidebar header (Chemical Properties) */
...
if analyze:
    ...
    if wine_score <= 4:
        quality, comment, emojis = "❌ POOR", "Low-quality wine with chemical imbalance.", "😞🍷"
    elif wine_score <= 6:
        quality, comment, emojis = "⚠️ AVERAGE", "Acceptable wine, commonly observed.", "🙂🍷"
    elif wine_score <= 8:
        quality, comment, emojis = "✅ GOOD", "High-quality, well-balanced wine.", "🎉🍷✨"
    else:
        quality, comment, emojis = "🌟 EXCELLENT", "Premium wine with outstanding characteristics.", "🥂🍾🌟🔥"
...
# ================= FOOTER =================
st.markdown(
    "<p style='text-align:center;margin-top:55px;color:#ffd6df;'>🍷 Streamlit Wine Quality Project | Error-Free Version | Devika ✨</p>",
    unsafe_allow_html=True
)
